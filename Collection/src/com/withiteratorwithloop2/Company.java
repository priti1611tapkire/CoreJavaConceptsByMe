package com.withiteratorwithloop2;
...
public class Company {
	public List<List<Employee>> designation(){       		
		...
		List<List<Employee>>manager=new ArrayList<>(); 
	...
	public static void main(String args[]){ 
		...
		List<List<Employee>>list=c.designation();
		Iterator<List<Employee>> itr=list.iterator();
		while(itr.hasNext()){
			Iterable<Employee>list1=itr.next();
